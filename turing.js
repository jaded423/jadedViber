...
(function () {
  ...
  // Rendered once from turing.jpg with `ascii-image-converter turing.jpg -c -W 56` and frozen here.
  const PORTRAIT = `jjjrrrrrxxnvcvuuvccvcccczzzXXUUUYXzzczcvnxjff/\\\\\\\\\\\\\\/tt
rrrjjrrxnuvccvuvcccvcczUYcvvuuvcczXJUzcvnxrjjfjfft/t/fjj
xrrrrrrxnnvccvvvccccXJXf{]]]]}{()1))jXzcuxjrjjjjfffjjjjr
rjrxxxxnuvccvvuvzzXCY\\_ii<~_})1}[-~!\`?Xcvnrrrrxjjjjrrrrr
rjjrrrxxnuvcccvczXUj>",;I!<-1()1[_i;>+jccuxrxxxrxrjjrrxx
xxxxxxxxxnvvvvvczJ/   .'^I>?[}[~i!>}(/(tXvvnnnnxnxrxnvvu
xrxxnnxnnuvvuvcczU1_<+-{/jnvzJCJUJmLtf\\]fYcvuuuunnnuvcvn
fjrxxxnnucccccccXYtLmpdbkkhoo**ooohqj[_i?Jccuuvvvnuuuvun
/tfjrrxnuccccczzUc{)tzmbdbho**oahkp0|i;"|Jcvvvvvvvvunuxx
\\\\/fjxnuvcczzzXXJ\\<;:"!fwZzt(/rXQmdmj?l~XXzcvvccvvunxnnx
|/tfrxuuccczzzzXUvunxx\\nkdL\\-?\\)jYwpnttuYXzzcvccuuunxxnn
\\/fjrxnucccczczXUzQwwwpM#*ohpmwwmqw0zrLJ\\Ycccvccvuuunnuu
//tjjrxnvvvcvczYJvvQwz(cYLkkhoooadqwZjzOXXzccccvcvvuuuvv
tttffjrnuuuvvvcXUcfcYYuvLmahdbhkdpppdwJXYYYXcvvvccvuuvvu
//\\/ffjxxnnnuvvzUztn\\{/xcQQQpqmmqdwJCXXUUYYXzzcccvuuunnn
)))(\\/fjrrnnnnvcYLnu0Yuxv0mOOqwmw0vJUYXYUYYzcXcccvunnxrx
{{{1)|/tttjxnvzUJn+\\rYqkhoobwmOQLw(rJCLCJUYXzcccvunnnxrx
{{{))|/tffrxxj\\}>^^JL1_[/vYUJL0qMk(]1\\fvUCCJYzcvuuunnxxx
{11(|//|)}[_l^''\`,"f*dJj11u0qaW%%z({}[]_]fvcXYYzcvunnnxx
{1{-+~i;,"^\`\`^^"^",-bh*hn[)U%@8Bq\\({{[?[~~_[})/xvzcnxxxr
)?I;,,,::,,^,,,"",;<0MOf?lvOY*$*f(1}1{_]-~~_?]--]1fcnxrj
]"Il:;I;::,\`'",",,:!(Jp}~<X%kOau)1{]][++]_~+-[]-_-_1nxrj
I::I:II;::,,,::,,:;l{0|I]{[Q@k(1{}}[--?]]?-_-?]-<-_>{xjf
;i;::llII:^:I;:::III>/_+)|{r&z}{}}]]]-?]-----??~!il~i}jt
;!<:";lll;^^I;::;III,I-?|\\)/p1]}}[-]-___?--]---l;;>il>|f
l;il",:llI;^"IIl!llI^^;I<--_][]][[??]~<_--_+_+<,";l!<i_f
<!;l,^,;l;;,'Iii>i!i;.'"","\`~[]]]]]]~+__+__~>>I':ll>ii~)
<ilI:^",,,::^^<<<>>i+;\`\`,,\`l?-??-?-<~_+~~<~<!;^"lllli++]
++iI,^",:;I;,\`,++<<i~~,;\`\`:~____?~i~~~+~<>i!I".:l!i~+~<?
>~_~I"",:,,,,"\`;_+<i<-\`"^^!<<~+_>li><<<<~>lI:'^::l<<ii-]
_~<>i:",,",:::,'l-~>>-:\`\`,><<~<Il<<>ii><<>lI".'\`:llI>-]]
-_~<>l"^,::::,,^'l~>i+I\`^Ii><!:Iiii<i!i>!I:"'.\`,;Ii>_?][
--_<iI,"":;:::""\`.;>i~l.:!li;,Il!l;;I;:::::".'":;!i>~-][
~~~<>l,^":;::I:,,^'Ii<I^I!l,,IllllI;;::,,""'.\`,:Il!i<_~_
_~>>>l"^^^"",,""",\`';I^;!:^:lI;;;;IlllIIII;\`'.\`",;l><i>_
?_<!lI:,,"",,,,:,,^'^^:I",IlI;::IIlllIIll!;''^",:I!><~_?
~+++<>l;;I:::::;Il,"\`:l:l!l;:,,,,:::;Ili>!:\`^";;I!l!i<+-
~<<<iiI;IIIIII;;;lI:;!i>iI;::;;Il>~++__+<l:::;Il<+_----?`;
  ...
  const CSS = `
    ...
    .tm-portrait {
      ...
      font-size: clamp(5.2px, 1.55vw, 10.5px); line-height: 1.05; letter-spacing: 0.02em;
      color: #b9c0d8; text-shadow: 0 0 12px rgba(139,233,253,0.12); white-space: pre; user-select: none;
    }
  ...
  function open() {
    ...
    backdrop.querySelector('.tm-portrait').textContent = PORTRAIT;
